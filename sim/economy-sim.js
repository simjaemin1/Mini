...
const RITE_PC = { jade: 0.0018, gold: 0.0009, silver: 0.0012, gem: 0.0006, amber: 0.0006, obsidian: 0.0012 };   // ★봉헌 요율 상향(2026-07-13 — candidate B, ×1.5: 위신 경제 확대·장식교역↑). 캐러밴 식량안보 가중과 세트(인계) — 단독 안전 시 세트 불요, fail-fast로 판정
