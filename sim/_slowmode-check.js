...
require(path.join(__dirname, 'economy-engine.browser.js'));
  ...
  const vals = { pop: '8', fertV: '0.55', waterV: '0.5', sizeMul: '1.5', compactW: '0', settType: 'nucleated', seed: '7', terrMode: 'auto', simSpeed: '12', nvil: '3' };
