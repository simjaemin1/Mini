...
const SPOTS = {
  ...
  // ── [배치 17 ①] 실내 컷어웨이 재현 자리 — 농촌22(중심 셀 964,1864)의 세 구조물 **안**에 선다.
  //   큰집 rect [960,1860,967,1867] · 움집 rect [965,1875,970,1878] · 곳간 rect [970,1871,974,1873]
  in_hall: { px: 30832, py: 59632, name: '큰집 안(963,1863)', walk: null },
  in_hut: { px: 30960, py: 60048, name: '움집 안(967,1876)', walk: null },
  in_gran: { px: 31120, py: 59920, name: '곳간 안(972,1872)', walk: null },
  // 밖에서 본 같은 건물들(비교용) — 큰집 남쪽 12셀
  out_hall: { px: 30832, py: 60016, name: '큰집 밖 남쪽(963,1875)', walk: null },
};
