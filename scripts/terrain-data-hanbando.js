...
module.exports = {
  ...
  ridges: [
    {
      name: '한울산괴', // 북서 모서리 매듭 — 배꽃강·너울강 발원지. 사합점 십자 은폐 + NW 틈 봉쇄
  ...
  // === 추가 호수 — 모서리 매듭 등 ===
  lakes: [
    // 북동 모서리 매듭 — 들말강·계주강 합수호. 사합점(bering/hanbando/nippon) 십자 은폐
    { name: '닭밭호', center: [70016, 0], radius: 2400 },
  ],
