...
// (쇠재·한재·대숲재·모새재·갈바람재·북계곡)과 겹치지 않게 고른다.
//
...
//   누른풀재·부전령 = 함경도 북부 고개(덕미고원 언저리)   덤불재 = 전라 너울산맥   여덟치 = 경남-전북 소백
const PASS_NAMES = [
  { at: [50465, 5599], name: '누른풀재', why: '북부 동측 — 함경 고원 관문' },
  { at: [46226, 5443], name: '부전령', why: '북부 동측 — 누른풀재 서쪽 짝' },
  { at: [6964, 97125], name: '덤불재', why: '남부 서측 · 너울산맥 계열' },
  { at: [64484, 100405], name: '여덟치', why: '남부 동측 · 소백 계열' },
];
