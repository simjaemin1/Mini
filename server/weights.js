...
const DERIVED_KG = {
  ...
  // ★★[부패·보존 배치 2026-08-31] 보존식 4종 — **표에 없어서 유도한 값**.
  //   근거는 하나다: **보존은 수분을 빼는 일**이다. 고증 수분 손실률을 원물 kg 에 곱했다.
  //   ⚠재민 확인 대상으로 `회부_부패_다음층.md` E 에 그대로 옮겨 적었다(조용히 정한 수는 못 고친다).
  dried_fish:   0.35,  // 생선 0.90 × 건조 잔량 ~0.39 (어육 수분 75~80% → 말리면 1/3 안팎. 북어 기준)
  dried_fruit:  0.13,  // 생과 0.50 × ~0.26 (과육 수분 85% → 곶감·건대추가 원물의 1/4)
  smoked_meat:  0.62,  // 고기 1.00 × ~0.62 (훈제는 말리기보다 수분을 덜 뺀다 — 훈연·염장 중심)
  pickled_veg:  0.66,  // 남새 0.60 × 1.1 (절임은 **무거워진다** — 소금·물을 머금는다. 독에 담는 물건)
};
