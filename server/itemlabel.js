...
const RESOURCE_VERBS = {
  ...
  sapling: '벌목',
  // ★[T372] 군락 종 넷 — **새 동사 0**. 넷 다 덤불·풀과 같은 손짓이라 위 '채집' 그 말이다.
  //   ⚠키를 여기 손으로 적는 것이 이 표의 뜻이다(위 머리말) — 자동으로 '채집'에 접히면
  //     새 종류가 조용히 지나간다. `test-itemlabel ⑭` 가 `RESOURCE_HP_TABLE` 전수와 맞대 본다.
  mushroom_patch: '채집', greens_patch: '채집', beehive: '채집', wild_vine: '채집',
};
