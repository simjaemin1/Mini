...
const ZONES_BASE = {
  korea: {
    ...
    worldOffsetX: 0,    worldOffsetY: 4096,
  ...
  usa: {
    ...
    worldOffsetX: 4096, worldOffsetY: 0,
  ...
  china: {
    ...
    worldOffsetX: 4096, worldOffsetY: 4096,
...
const WORLD = {
  // Phase 12.2 — zone 4배 (1024→4096). 청크 시스템으로 활성 청크만 tick 처리.
  zoneWidth: 4096,
  zoneHeight: 4096,
  tileSize: 32,
