...
// === CLIENT BUILD: 14.49-e3-perf5 (idle zone tick skip) ===
console.log('%c[durango-mini] client build = 14.49-e3-perf5 (idle zone skip)', 'color:#5a9ae0;font-weight:bold;font-size:14px');
