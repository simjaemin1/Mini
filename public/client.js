...
// === CLIENT BUILD: 14.49-e6f (미지 zone placeholder tile — stairstep 진짜 fix) ===
console.log('%c[durango-mini] client build = 14.49-e6f (stairstep 진짜 fix)', 'color:#5a9ae0;font-weight:bold;font-size:14px');
