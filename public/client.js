...
// === CLIENT BUILD: Phase 4d-14d (caravan A* path 우회 X — 직진 500 px/s) ===
console.log('%c[durango-mini] client build = Phase 4d-14d (caravan A* skip, 진짜 500 px/s 직진)', 'color:#5a9ae0;font-weight:bold;font-size:14px');
