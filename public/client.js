...
// === CLIENT BUILD: 14.49-e3-perf4 (findStairStepFor도 cache) ===
console.log('%c[durango-mini] client build = 14.49-e3-perf4 (모든 stair cache)', 'color:#5a9ae0;font-weight:bold;font-size:14px');
