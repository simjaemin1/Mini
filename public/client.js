...
// === CLIENT BUILD: Phase 4d-10 (캐나디아 경제 통합 + NPC 캐러밴 + 마을 작업장 시각화) ===
console.log('%c[durango-mini] client build = Phase 4d-10 (캐나디아 시뮬·캐러밴·작업장 + 상인 stuck fix)', 'color:#5a9ae0;font-weight:bold;font-size:14px');
...
(() => {
  ...
  function render() {
    ...
    // === Phase 4d-3: 캐나디아 캐러밴 (행상) 시각화 ===
    if (primaryZoneId === 'canadia' && _canadiaCaravans.length) {
      const ox = pConn.meta.worldOffsetX || 0;
      const oy = pConn.meta.worldOffsetY || 0;
