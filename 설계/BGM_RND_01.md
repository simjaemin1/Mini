...
이 판정은 불통과였다. R&D-02에서는 발견된 실제 대금 backup을 격리 복원해 head·hold·검증된 원본 전이를 먼저 듣고, 그 위에 articulation 상태를 만든다. 설령 통과했더라도 "AI 악기 학습 성공"은 아니며, 그때 비로소 권리 확인된 대금 단선율 프레이즈로 data/rendering 카드를 연다.
